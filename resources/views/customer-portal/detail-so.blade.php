...
@section('title','Detail Purchase Order - Customer Portal PT Indo Greenlife Harvest ')
@section('content')
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table align-middle">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><a href="{{url('customer-portal/product/detail')}}">Jack Hammer Weight Gainer </a></td>
                                                        <td><a href="{{url('customer-portal/sample/detail')}}">IGH05420</a></td>
                                                        <td>900.00</td>
                                                        <td>2,500</td>
                                                        <td>85,000.00</td>
                                                        ...
                                                        <td> <a href="{{url('customer-portal/detail-po')}}" class="btn btn-light-primary btn-xs">
