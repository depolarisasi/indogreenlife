@extends('layouts.app')
@section('title','Tambah Pengguna - PT Indo Greenlife Harvest ')
@section('css')
<style>
.checkbox-list {
    display: -webkit-box;
                ...
                <div id="kt_app_content" class="app-content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{url('user/store')}}" method="post"  enctype="multipart/form-data">
                                @csrf
                                <!--begin::Card body-->
                                <div class="card-body border-top p-9">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="name" class="form-control form-control-lg form-control-solid" placeholder="Nama Lengkap">
                                                </div>
                                                <!--end::Col-->
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                            <input type="email" name="email" class="form-control form-control-lg form-control-solid" placeholder="Alamat Email">
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <div class="row mb-6">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                            <input type="tel" name="nohp" class="form-control form-control-lg form-control-solid" placeholder="Phone number">
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                            <input type="text" name="nomorinduk" class="form-control form-control-lg form-control-solid" placeholder="Nomor Induk">
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--begin::Input group-->
