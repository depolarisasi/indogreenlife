                                ...
                                <div class="card-body pt-3">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <!--begin::Stat-->
                                            <div class="border border-success border-solid rounded min-w-250px py-3 px-4 me-6 mb-3">
                                                <!--begin::Number-->
                                                ...
                                                <!--end::Number-->
                                                <!--begin::Label-->
                                                <div class="fw-bold fs-6">Processing PPIC</div>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Stat-->
                                            <!--begin::Stat-->
                                            ...
                                            <!--end::Stat-->
                                            <!--begin::Stat-->
                                            <div class="border border-warning border-solid rounded min-w-250px py-3 px-4 me-6 mb-3">
                                                <!--begin::Number-->
                                                <div class="d-flex align-items-center">
                                            ...
                                            <!--end::Stat-->
                                            <!--begin::Stat-->
                                            <div class="border border-grey border-solid rounded min-w-250px py-3 px-4 me-6 mb-3">
                                                <!--begin::Number-->
                                                <div class="d-flex align-items-center">
                                                ...
                                                <!--end::Number-->
                                                <!--begin::Label-->
                                                <div class="fw-bold fs-6">Produksi Selesai</div>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Stat-->
                                        </div>
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="table-responsive mt-3">
                                            ...
                                            <table class="table align-middle">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><a href="{{url('raw-material/detail')}}">AKA23232 - Whey Protein Concentrat 90% merk Yinlong </a></td>
                                                        <td>15,000</td>
                                                      </tr>
                                                      <tr>
                                                        <td><a href="{{url('raw-material/detail')}}">AKA23232 - Whey Protein Concentrat 90% merk Yinlong </a></td>
